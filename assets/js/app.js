...
const menuToggleButton = document.querySelector('.menu-toggle-button'); /* constante llamada menuToggleButton que llama a el id del mismo nombre */
const menuElement = document.querySelector('.menu'); /* constante llamada menuElement que llama a menu */
